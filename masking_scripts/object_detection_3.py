...
folder='masking_scripts\Flame'
images=[]
filename1 = "masking_scripts/segmented_images_flame/img" ## something that changes in this loop -> you can set a complete path to manage folders
i=1
